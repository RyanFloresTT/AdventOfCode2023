...
Console.WriteLine($"DayFive Part One: {await Day5.PartOne()}");
Console.WriteLine($"DayFive Part Two: {await Day5.PartTwo()}");
Console.WriteLine($"DaySix Part One: {await Day6.PartOne()}");*/
Console.WriteLine($"DaySix Part One: {await Day6.PartTwo()}");