...
public class Tests
{
    ...
    {
        var res = DayOne.PartOne("part_one_example.txt");
    ...
    {
        var res = DayOne.PartTwo("part_two_example.txt");
    ...
    {
        var res = DayTwo.PartOne("example.txt");
    ...
    {
        var res = DayTwo.PartTwo("example.txt");
    ...
    {
        var res = DayThree.PartOne("example.txt");
